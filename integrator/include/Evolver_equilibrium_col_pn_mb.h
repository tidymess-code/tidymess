...
#ifndef __Evolver_equilibrium_col_pn_mb_h
#define __Evolver_equilibrium_col_pn_mb_h

class Evolver_equilibrium_col_pn_mb : public Evolver_shape_base {
    public:
    ...
    void sync_step(vector<Body> &bodies, Force *force);    
